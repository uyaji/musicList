    ...
    <div id="main" data-lift="surround?with=default;at=content">
      ...
      <lift:Util.in>
        ...
        <form class="lift:AlbumView.add?form=post">
          ...
          <label for="artisname">artist name</label>
          <input name="artistname"><br />
          <label for="artistseq">artist seq&nbsp&nbsp&nbsp&nbsp</label>
          <input name="artistseq">
          <input type="submit" value="Add Album!"/>
        </form>
        <hr />
        <form class="lift:AlbumView.search?form=post">
          <label>search filter</label><br />
          <label for="searchAlbumtitle">album title</label>
          <input name="searchAlbumtitle" id="searchAlbumtitle" >
