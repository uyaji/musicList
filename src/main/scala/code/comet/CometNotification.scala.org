  ...
  override def lowPriority = {
    case msg: Message  => {
      ...
      notifArray.size match {
        ...
        case _ => {
          val messageExistCount = Message.findAllByPreparedStatement(con => con.connection.prepareStatement("SELECT from_C FROM message WHERE to_c = " + User.currentUser.head.id.get + " GROUP BY from_C")).size
